<?php
$pageTitle = "Business cards"; // Define el título de la página
        ...
        <header class=" text-center container">
            <div class="row">
                <div class="col-lg-12 col-md-12 mx-auto text-center">
                    <h2 class="text-muted " id="multicolor" style="font-weight: lighter">Business Cards</h2>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="image-container position-relative">
                                <img src="/images/webSiteImages/cardPress/card4.png" alt="Real estate Image" class="img-fluid expandable-image" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="changeModalImage(this)">
                                <div class="image-number">#A1</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="image-container position-relative">
                                <img src="/images/webSiteImages/cardPress/card5.png" alt="Real estate" class="img-fluid expandable-image" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="changeModalImage(this)">
                                <div class="image-number">#A2</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="image-container position-relative">
                                <img src="/images/webSiteImages/cardPress/card4.png" alt="Real estate" class="img-fluid expandable-image" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="changeModalImage(this)">
